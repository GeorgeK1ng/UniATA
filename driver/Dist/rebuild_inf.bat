...
build_inf.exe uata_w7.in_ > uata_w7.inf
copy uata_w7.inf uata_w7h.inf
srchrep -src "%%COMMENT%%" -dest "" uata_w7.inf              > nul
srchrep -src "Class=SCSIAdapter" -dest "Class=hdc" uata_w7h.inf > nul
srchrep -src "ClassGuid={4D36E97B-E325-11CE-BFC1-08002BE10318}" -dest "ClassGuid={4D36E96A-E325-11CE-BFC1-08002BE10318}" uata_w7h.inf > nul
srchrep -src "%%COMMENT%%" -dest " (SCSI)" uata_w7h.inf      > nul
