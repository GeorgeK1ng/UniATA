...
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /ZI /Od /I "$(BASEDIR)\src\storage\inc" /I "$(BASEDIR)\\inc" /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "USER_MODE" /D _WIN32_WINNT=0x0400 /Fp"$(INTDIR)\atactl.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\atactl.bsc" 
BSC32_SBRS= \
